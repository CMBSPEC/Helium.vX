...
double compute_Dnuc_QD(int n, int l, int s, int j)
{
  ...
  else{ cout << " compute_Dnuc:: oops " << endl; return 0.0; }
    
  //cout << d0 << " " << d2 << " " << d4 << " " << d6 << " " << d8 << endl;
...
int main()
{
  //cout << compute_Dnuc_QD(1, 0, 0, 0) << endl;
  //cout << compute_Dnuc_QD(2, 0, 0, 0) << endl;
  //cout << compute_Dnuc_QD(2, 1, 0, 0) << endl;
  //cout << compute_Dnuc_QD(3, 0, 0, 0) << endl;
  //cout << compute_Dnuc_QD(2, 0, 1, 1) << endl;
  //cout << compute_Dnuc_QD(30, 1, 0, 0) << endl;
  //cout << compute_Dnuc_QD(30, 6, 0, 0) << endl;
