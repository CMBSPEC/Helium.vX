...
atomic-model setup. It is intended to hold the Helium atom class and the data
tables that belong directly to that class, without copying the more general
...
code from the surrounding CMBSPEC/CosmoSpec toolchain, including physical
constants, file I/O helpers, interpolation/integration routines, Voigt profiles,
hydrogenic bound-bound and photoionization routines.
